          ...
          <div className="relative text-center py-20 px-8">
            <div className="max-w-4xl mx-auto">
              <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 rounded-full px-4 py-2 mb-6">
                <span className="text-orange-400 text-sm font-inter font-medium">👨‍🎓 User Registration</span>
              </div>
              <h1 className="text-6xl md:text-7xl font-poppins font-bold text-white mb-6 leading-tight">
                Join <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">CampusKart</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 font-inter leading-relaxed max-w-2xl mx-auto">
                Create your account to start buying, selling, and managing your campus essentials.
              </p>
            </div>
          </div>
        </section>
